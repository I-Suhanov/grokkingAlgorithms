...
public class DijkstrasAlgorithm {
    ...
    private static String findLowerstCostNode(Map<String,Double> costs){
    ...
    public void algorithmDijkstras(){
        ...
        String node = findLowerstCostNode(costs);
        while (node != null){
            ...
            node = findLowerstCostNode(costs);
        }
        System.out.print("Стоимость от начала до каждого узла: ");
